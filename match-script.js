...
/*
divs[i].style.backgroundColor = colorArr[colorChoice];
		var hide = document.getElementById("flip2");
...
//default board
	...
	/*
				...
				var findColor = this.style.backgroundColor;
				matchArr.push(findColor);
				console.log(matchArr);
			})
		}
